...
export const skillsData: skillsItemType[] = [
  ...
  { label: 'CSS', type: 'Languages', rating: 8 , years: 10 },
  ...
  { label: 'Highcharts', type: 'Integrations', rating: 5 , years: 3 },
  { label: 'SSO', type: 'Integrations', rating: 6 , years: 2 },
  { label: 'Mapbox', type: 'Integrations', rating: 6 , years: 5 },
  { label: 'AWS', type: 'Integrations', rating: 7 , years: 5 },
  { label: 'GWS', type: 'Integrations', rating: 5 , years: 3 },
